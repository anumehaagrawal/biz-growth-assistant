    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          Paste your homepage — Outreach.AI will read every page on your site and use them all as context.
        </p>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          PDFs, Word docs, or text files (max 10 MB each). Annual reports, mission docs, brochures, program one-pagers — anything that helps Outreach.AI write in your voice.
        </p>
        <button
          type="button"
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-border bg-card/50 p-6 text-center text-sm text-muted-foreground">
            No resources yet. Add some so Outreach.AI can write from your real materials.
          </div>
        ) : (
