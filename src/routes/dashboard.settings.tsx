...
export const Route = createFileRoute("/dashboard/settings")({
  head: () => ({ meta: [{ title: "Organization settings — Outreach.AI" }] }),
...
function SettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-2 text-muted-foreground">Keep this fresh — Outreach.AI uses it for everything it writes.</p>
        ...
        <div className="mb-5 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Add your website, annual report, mission docs, brochures — Outreach.AI uses these as source material whenever it writes content or builds your outreach plan.
            </p>
          </div>
        </div>
        <ResourceManager />
